      ...
      <Grid spacing={2} container>
        <Grid item md={7}>
          <div className="flex h-full flex-col justify-between">
            <Paper className="px-3 py-4 shadow-lg w-full">
              <Swiper
              ...
              <div className="mt-6 flex text-body">
            ...
            <Grid container spacing={2} className="mt-5">
              <Grid item md={4} className="flex flex-col">
                <div className="mb-4">
              ...
              <Grid item md={8} className="flex flex-col">
                <div className="mb-4">
        ...
        <Grid item md={5}>
          <Paper className="p-5 h-full">
            ...
            <TabPanel value={value} index={1}>
              <div className="px-4 max-h-[650px] overscroll-auto overflow-auto">
                  ...
                  <>
                    ...
                    <div className="mt-4">
                      <p className="text-[13px] text-gray-500 text-roboto">
                        ...
                        elit. Dignissimos ipsa officia et ullam animi eos,
                        aspernatur obcaecati sequi laboriosam vel temporibus id
                        libero qui tempore culpa odio perspiciatis hic nam.
                      </p>
                      <p className="text-[13px] text-gray-500 text-roboto">
                        Lorem ipsum dolor, sit amet consectetur adipisicing
                        elit. Inventore nesciunt ullam, sed aperiam et aliquam
                        provident vitae eos delectus dolorem totam est minima
                        qui quibusdam modi, rerum reiciendis? Pariatur, omnis.
